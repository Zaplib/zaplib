...
cargo check --release --workspace --target x86_64-apple-darwin --no-default-features --exclude zaplib_cef --exclude zaplib_cef_sys --exclude test_suite --exclude tutorial_js_rust_bridge --exclude cargo-zaplib --exclude zaplib_ci
cargo check --release --workspace --target x86_64-pc-windows-msvc --no-default-features --exclude zaplib_cef --exclude zaplib_cef_sys --exclude test_suite --exclude tutorial_js_rust_bridge --exclude cargo-zaplib --exclude zaplib_ci
cargo check --release --workspace --target x86_64-pc-windows-gnu --no-default-features --exclude zaplib_cef --exclude zaplib_cef_sys --exclude test_suite --exclude tutorial_js_rust_bridge --exclude cargo-zaplib --exclude zaplib_ci
